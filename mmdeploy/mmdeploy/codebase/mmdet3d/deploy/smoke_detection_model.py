...
__BACKEND_MODEL = Registry('backend_smoke_detectors')


@__BACKEND_MODEL.register_module('end2end')
class SmokeDetectionModel(BaseBackendModel):
    """End to end model for inference of 3d smoke detection.
    ...
    def forward(self,
        ...
        Args:
            inputs (dict): A dict contains `img` which wrapped `img`
        ...
        input_dict = {
            'img': preprocessed['imgs'].to(self.device)
        }
        ...
        prediction = SmokeDetectionModel.postprocess(
    ...
    def postprocess(model_cfg: Union[str, Config],
        ...
        if not hasattr(head, 'task_heads'):
            ...
            data_samples = SmokeDetectionModel.convert_to_datasample(
...
def build_smoke_detection_model(
        ...
        **kwargs):
    """Build 3d smoke object detection model for different backends.
    ...
    Returns:
        SmokeDetectionModel: Detector for a configured backend.
    """
